...
namespace Varneon.VUdon.Logger.Abstract
{
    /// <summary>
    ...
    public abstract class UdonLogger : UdonSharpBehaviour
    {
        ...
        /// <summary>
        /// A variant of Log that logs a warning message
        /// </summary>
        /// <param name="message">String or object to be converted to string representation for display</param>
        [PublicAPI]
        ...
        /// <summary>
        /// A variant of Log that logs a warning message with context
        /// </summary>
        /// <param name="message">String or object to be converted to string representation for display</param>
        /// <param name="context">Object to which the message applies</param>
        [PublicAPI]
        ...
        /// <summary>
        /// A variant of Log that logs an error message with context
        /// </summary>
        /// <param name="message">String or object to be converted to string representation for display</param>
        /// <param name="context">Object to which the message applies</param>
        [PublicAPI]
        ...
        [PublicAPI]
        public virtual void ClearLogs(LogType logType) { }
        ...
        {
            if(context == null) { return "<color=#808080ff>(<color=#c0c0c0ff>null</color>)</color>"; }

            return string.Format("<color=#808080ff>(<color=#c0c0c0ff>{0}</color>, <color=#c0c0c0ff>{1}</color>)</color>", context.name, context.GetInstanceID());
        }
